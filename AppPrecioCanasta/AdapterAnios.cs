...
namespace AppPrecioCanasta
{
    class AdapterAnios : BaseAdapter
    {
        ...
        Activity context;
        List<Global.Anio> lista;

        public AdapterAnios(Activity context, List<Global.Anio> lista)
        {
        ...
        public override View GetView(int position, View convertView, ViewGroup parent)
        {
            ...
            view.FindViewById<TextView>(Android.Resource.Id.Text1).Text = "Año " + item.Año.ToString();
